package com.spring.demo.springpatterndemo.aop.aspect;
...
public class ArgsAspect {
	...
	@Before("execution(com.spring.demo.springpatterndemo.aop.model.Member com.spring.demo.springpatterndemo.aop.service..*(..))")
	public void beforeReturnUser(JoinPoint joinPoint){
		log.info("beforeReturnUser " + joinPoint);
	}

	//配置前置通知,拦截参数为cn.ysh.studio.spring.mvc.bean.User的方法
	@Before("execution(* com.spring.demo.springpatterndemo.aop.service..*(com.spring.demo.springpatterndemo.aop.model.Member))")
